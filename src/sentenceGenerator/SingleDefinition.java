 ...
 * <code>ListOfDefinitions</code> object. It consists of one definition (a
 * sequence of terminals and/or nonterminals) with no <code>'|'</code> symbols,
 * not including the thing being defined (the "definiendum"). For example, given
 * the rule</br></br> &lt;verb phrase&gt; ::= &lt;intransitive verb&gt; |
 * &lt;transitive verb&gt; &lt;noun phrase&gt;<br />
 * </br> then &lt;intransitive verb&gt; is a SingleDefinition, and so is
